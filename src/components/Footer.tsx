        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-primary-foreground/80 mb-4">
              Global Distributor of advanced lithium-ion battery fire suppression products, including
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/products/fire-quit" className="hover:text-accent transition-colors">
                  Fire Quit™
                </Link>
              </li>
              <li>
                <Link to="/products/elixir-5" className="hover:text-accent transition-colors">
                  Elixir 5™
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/distributors" className="hover:text-accent transition-colors">
                  Distributors
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href="tel:1-833-466-5835" className="hover:text-accent transition-colors">
                  1-833-ion-ktek
                </a>
              </li>
              <li className="flex items-start gap-2">
