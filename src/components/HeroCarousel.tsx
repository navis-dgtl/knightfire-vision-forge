...
const HeroCarousel = () => {
  ...
  return (
    <div className="relative h-[600px] md:h-[700px] overflow-hidden bg-primary">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-2 md:left-4 top-[30%] md:top-1/2 -translate-y-1/2 z-20 bg-primary-foreground/10 hover:bg-primary-foreground/20 text-primary-foreground p-1 md:p-1.5 rounded-full backdrop-blur-sm transition-colors"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-2 md:right-4 top-[30%] md:top-1/2 -translate-y-1/2 z-20 bg-primary-foreground/10 hover:bg-primary-foreground/20 text-primary-foreground p-1 md:p-1.5 rounded-full backdrop-blur-sm transition-colors"
