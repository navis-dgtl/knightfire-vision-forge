  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-20 lg:pt-28 bg-accent">
        <div className="container mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-center gap-6 text-center">
          ...
          <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold">
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSdWO3eZ782UeRQlpdyxxa0dBpbPCc9Hmh6w7wUWnSalaSWXvQ/viewform?usp=sharing&ouid=104058984404542782577"
              target="_blank"
