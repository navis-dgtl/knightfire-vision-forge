-- Content publishing system: posts table powering the /publications page.
-- Lets admins create articles, news, videos, and publications without code changes.
...
-- Anyone may read published posts; only admins see drafts.
...
-- Storage bucket for post media (featured images, inline images, PDFs).
...
-- Seed the existing hardcoded /publications content so nothing is lost.
